...
import { rejectRequest } from "@/lib/services/membership-service";
...
/**
 * POST /api/groups/[groupId]/requests/[userId]/reject - Reject join request (owner or admin)
 */
export async function POST(
  ...
  try {
    ...
    await rejectRequest(groupId, actorUserId, targetUserId);
